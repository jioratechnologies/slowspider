// 1:1 port of apps/web's src/lib/types.ts — the row shapes returned by the board/notes
// endpoints. Kept identical so response shapes don't drift between the two backends.
